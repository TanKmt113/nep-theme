...
<section id="contact" style="position:relative;padding:var(--space-12) 0;overflow:hidden">
  <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=1800&q=80" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
  ...
  <x-container :style="'position:relative;text-align:center'">
    <h2 style="color:#fff;font-size:var(--text-display-xl);line-height:1.05;max-width:18ch;margin:0 auto;text-wrap:balance">
      Nâng tầm không gian sống của bạn ngay hôm nay
    </h2>
    <div style="display:flex;gap:14px;justify-content:center;margin-top:38px;flex-wrap:wrap">
      <x-button href="{{ nep_tel(nep('hotline')) }}" size="lg" variant="gold"><x-icon name="phone" :size="18" /> Gọi ngay</x-button>
      <x-button href="{{ home_url('/lien-he') }}" size="lg" variant="secondary">Đăng ký tư vấn</x-button>
    </div>
  </x-container>
</section>
